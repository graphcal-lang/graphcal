//! Typed registry of plot, mark, and figure/layer properties.
//!
//! The single source of truth for which property names exist on each
//! plot-family declaration and what value type each expects. Validation
//! (TIR check), evaluation, and rendering all dispatch on these enums —
