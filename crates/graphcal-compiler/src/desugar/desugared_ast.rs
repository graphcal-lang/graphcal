...
pub type ExternFnDecl = crate::syntax::ast::ExternFnDecl<Desugared>;
...
pub type DimExprItem = crate::syntax::ast::DimExprItem;
pub type DimTerm = crate::syntax::ast::DimTerm;
