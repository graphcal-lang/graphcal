...
/// # Errors
///
/// Returns a [`GraphcalError`] if there is a cyclic dependency in the graph.
pub fn build_dag(
    resolved: &ResolvedFile,
    src: &NamedSource<Arc<String>>,
) -> Result<RuntimeGraph, GraphcalError> {
...
mod tests {
    ...
    fn parse_resolve_build(source: &str) -> Result<RuntimeGraph, GraphcalError> {
