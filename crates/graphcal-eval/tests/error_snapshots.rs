...
fn error_duplicate_name() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/duplicate.gcl");
...
fn error_unknown_graph_ref() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/unknown_ref.gcl");
...
fn error_unknown_const_ref() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/unknown_const_ref.gcl");
...
fn error_at_in_const() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/at_in_const.gcl");
...
fn error_runtime_cycle() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/cycle.gcl");
...
fn error_const_cycle() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/const_cycle.gcl");
...
fn error_unknown_function() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/unknown_function.gcl");
...
fn error_wrong_arity() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/wrong_arity.gcl");
...
fn error_dim_mismatch_add() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/dim_mismatch_add.gcl");
...
fn error_dim_mismatch_annotation() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/dim_mismatch_annotation.gcl");
...
fn error_exp_requires_dimensionless() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/exp_requires_dimensionless.gcl");
...
fn error_unknown_unit() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/unknown_unit.gcl");
...
fn error_conversion_dim_mismatch() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/conversion_dim_mismatch.gcl");
...
fn error_unknown_struct_field() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/unknown_struct_field.gcl");
...
fn error_struct_field_dim_mismatch() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/struct_field_dim_mismatch.gcl");
...
fn error_missing_struct_field() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/missing_struct_field.gcl");
...
fn error_recursive_fn() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/recursive_fn.gcl");
...
fn error_unknown_dimension() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/unknown_dimension.gcl");
...
fn error_extra_struct_fields() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/extra_struct_fields.gcl");
...
fn error_not_a_struct() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/not_a_struct.gcl");
...
fn error_unknown_index() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/unknown_index.gcl");
...
fn error_unknown_variant() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/unknown_variant.gcl");
...
fn error_missing_variants() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/missing_variants.gcl");
...
fn error_extra_variants() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/extra_variants.gcl");
...
fn error_index_mismatch() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/index_mismatch.gcl");
...
fn error_non_literal_exponent() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/non_literal_exponent.gcl");
...
fn error_boolean_dim_error() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/boolean_dim_error.gcl");
...
fn error_division_by_zero() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/division_by_zero.gcl");
...
fn error_sqrt_negative() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/sqrt_negative.gcl");
...
fn error_non_exhaustive_match() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/non_exhaustive_match.gcl");
...
fn error_duplicate_match_arm() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/duplicate_match_arm.gcl");
...
fn error_match_arm_type_mismatch() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/match_arm_type_mismatch.gcl");
...
fn error_field_access_multi_variant() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/field_access_multi_variant.gcl");
...
fn error_range_index_dim_mismatch() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/range_index_dim_mismatch.gcl");
...
fn error_range_index_invalid() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/range_index_invalid.gcl");
...
#[test]
fn error_at_assert() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/at_assert.gcl");
...
fn error_assert_not_bool() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/assert_not_bool.gcl");
...
fn error_assumes_unknown_assert() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/assumes_unknown_assert.gcl");
...
fn error_assumes_on_const() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/assumes_on_const.gcl");
...
fn error_unknown_attribute() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/unknown_attribute.gcl");
...
fn error_expected_fail_on_node() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/expected_fail_on_node.gcl");
...
fn error_expected_fail_all_on_indexed() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/expected_fail_all_on_indexed.gcl");
...
fn error_non_exhaustive_index_match() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/non_exhaustive_index_match.gcl");
...
fn error_index_match_with_bindings() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/index_match_with_bindings.gcl");
...
fn error_nested_indexed_map() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/nested_indexed_map.gcl");
...
fn error_table_row_mismatch() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/table_row_mismatch.gcl");
...
fn error_datetime_scale_mismatch() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/datetime_scale_mismatch.gcl");
...
fn error_datetime_conversion_non_datetime() {
    let source =
        include_str!("../../../tests/fixtures/invalid/errors/datetime_conversion_non_datetime.gcl");
...
fn error_datetime_extract_non_datetime() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/datetime_extract_non_datetime.gcl");
...
fn error_datetime_timezone_non_datetime() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/datetime_timezone_non_datetime.gcl");
...
fn error_invalid_timezone() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/invalid_timezone.gcl");
...
fn error_domain_violation() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/domain_violation.gcl");
...
fn error_domain_min_exceeds_max() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/domain_min_exceeds_max.gcl");
...
fn error_domain_on_bool() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/domain_on_bool.gcl");
...
fn error_domain_invalid_key() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/domain_invalid_key.gcl");
...
fn error_variant_literal_in_node() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/variant_literal_in_node.gcl");
...
fn error_variant_literal_in_const() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/variant_literal_in_const.gcl");
...
fn error_pub_assert_variant_literal() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/pub_assert_variant_literal.gcl");
...
fn error_required_index_standalone() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/required_index_standalone.gcl");
...
fn error_required_param_not_pub() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/required_param_not_pub.gcl");
...
fn error_required_index_not_pub() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/required_index_not_pub.gcl");
...
fn error_private_in_public() {
    let source = include_str!("../../../tests/fixtures/invalid/errors/private_in_public.gcl");
