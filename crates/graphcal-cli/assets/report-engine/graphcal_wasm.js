let wasm_bindgen = (function(exports) {
     ...
     */
    class PreparedProjectHandle {
        static __wrap(ptr) {
            const obj = Object.create(PreparedProjectHandle.prototype);
            obj.__wbg_ptr = ptr;
            PreparedProjectHandleFinalization.register(obj, obj.__wbg_ptr, obj);
            return obj;
        }
        __destroy_into_raw() {
            const ptr = this.__wbg_ptr;
            this.__wbg_ptr = 0;
            PreparedProjectHandleFinalization.unregister(this);
            return ptr;
        }
        free() {
            const ptr = this.__destroy_into_raw();
            wasm.__wbg_preparedprojecthandle_free(ptr, 0);
        }
        /**
         ...
         * @returns {any}
         */
        evaluateBindings(bindings) {
            const ret = wasm.preparedprojecthandle_evaluateBindings(this.__wbg_ptr, bindings);
            if (ret[2]) {
         ...
         */
        parameterPorts() {
            const ret = wasm.preparedprojecthandle_parameterPorts(this.__wbg_ptr);
            if (ret[2]) {
                throw takeFromExternrefTable0(ret[1]);
            }
            return takeFromExternrefTable0(ret[0]);
    ...
    if (Symbol.dispose) PreparedProjectHandle.prototype[Symbol.dispose] = PreparedProjectHandle.prototype.free;
    exports.PreparedProjectHandle = PreparedProjectHandle;
     ...
     * @returns {any}
     */
    function evaluateProject(request) {
        const ret = wasm.evaluateProject(request);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @param {any} request
     * @returns {PreparedProjectHandle}
     */
    function prepareProject(request) {
        const ret = wasm.prepareProject(request);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return PreparedProjectHandle.__wrap(ret[0]);
    }
    ...
    function __wbg_get_imports() {
        const import0 = {
            ...
            __wbg_isArray_264dd3fb3df7f1a4: function() { return handleError(function (arg0) {
        ...
        return {
            __proto__: null,
            "./graphcal_wasm_bg.js": import0,
        };
    }

    const PreparedProjectHandleFinalization = (typeof FinalizationRegistry === 'undefined')
        ? { register: () => {}, unregister: () => {} }
        : new FinalizationRegistry(ptr => wasm.__wbg_preparedprojecthandle_free(ptr, 1));
