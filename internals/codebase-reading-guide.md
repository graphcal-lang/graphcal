...
44. `crates/graphcal-compiler/src/node_definition.rs`
45. `crates/graphcal-compiler/src/syntax/ast/value.rs`
46. `crates/graphcal-compiler/src/syntax/doc_attach.rs`
47. `crates/graphcal-compiler/src/syntax/ast/decl.rs`
48. `crates/graphcal-compiler/src/syntax/ast.rs`
49. `crates/graphcal-compiler/src/syntax/ast/format_equivalent.rs`
50. `crates/graphcal-compiler/src/syntax/parser/mod.rs`
51. `crates/graphcal-compiler/src/syntax/visitor.rs`
52. `crates/graphcal-compiler/src/syntax/parser/compound.rs`
53. `crates/graphcal-compiler/src/syntax/parser/type_expr.rs`
54. `crates/graphcal-compiler/src/syntax/parser/expr.rs`
55. `crates/graphcal-compiler/src/syntax/parser/table.rs`
56. `crates/graphcal-compiler/src/syntax/parser/decl/dim_unit.rs`
57. `crates/graphcal-compiler/src/syntax/parser/decl/index.rs`
58. `crates/graphcal-compiler/src/syntax/parser/decl/type_decl.rs`
59. `crates/graphcal-compiler/src/syntax/parser/decl/import.rs`
60. `crates/graphcal-compiler/src/syntax/parser/decl/dag.rs`
61. `crates/graphcal-compiler/src/syntax/parser/decl/layer.rs`
62. `crates/graphcal-compiler/src/syntax/parser/decl/plot.rs`
63. `crates/graphcal-compiler/src/syntax/parser/decl/figure.rs`
64. `crates/graphcal-compiler/src/syntax/parser/decl/tests.rs`
65. `crates/graphcal-compiler/src/syntax/desugar.rs`
66. `crates/graphcal-compiler/src/desugar/desugared_ast.rs`
67. `crates/graphcal-compiler/src/desugar/convert.rs`
68. `crates/graphcal-compiler/src/registry/format.rs`
69. `crates/graphcal-compiler/src/function_signature.rs`
70. `crates/graphcal-compiler/src/registry/dag.rs`
71. `crates/graphcal-compiler/src/registry/dimension_registry.rs`
72. `crates/graphcal-compiler/src/registry/index.rs`
73. `crates/graphcal-compiler/src/registry/type_def.rs`
74. `crates/graphcal-compiler/src/registry/unit.rs`
75. `crates/graphcal-compiler/src/registry/types.rs`
76. `crates/graphcal-compiler/src/registry/prelude.rs`
77. `crates/graphcal-compiler/src/registry/reserved_name.rs`
78. `crates/graphcal-compiler/src/registry/declared_type.rs`
79. `crates/graphcal-compiler/src/assertion_expectation.rs`
80. `crates/graphcal-compiler/src/registry/resolve_types.rs`
81. `crates/graphcal-compiler/src/diagnostic_anchor.rs`
82. `crates/graphcal-compiler/src/registry/runtime_value.rs`
83. `crates/graphcal-compiler/src/syntax/module_resolve.rs`
84. `crates/graphcal-compiler/src/ir/resolve/deps.rs`
85. `crates/graphcal-compiler/src/registry/builtins.rs`
86. `crates/graphcal-compiler/src/ir/imported_binding.rs`
87. `crates/graphcal-compiler/src/ir/override_reconciliation.rs`
88. `crates/graphcal-compiler/src/tir/materialized_shape.rs`
89. `crates/graphcal-compiler/src/syntax/parser/decl/multi.rs`
90. `crates/graphcal-compiler/src/syntax/parser/decl/mod.rs`
91. `crates/graphcal-compiler/src/syntax/parser/decl/value.rs`
92. `crates/graphcal-compiler/src/plot_props.rs`
93. `crates/graphcal-compiler/src/plot_shape.rs`
94. `crates/graphcal-compiler/src/static_interface.rs`
95. `crates/graphcal-compiler/src/ir/mod.rs`
96. `crates/graphcal-compiler/src/node_unavailable.rs`
97. `crates/graphcal-compiler/src/registry/error.rs`
98. `crates/graphcal-compiler/src/ir/required_bindability.rs`
99. `crates/graphcal-compiler/src/ir/resolve/names.rs`
100. `crates/graphcal-compiler/src/ir/resolve/mod.rs`
101. `crates/graphcal-compiler/src/ir/resolve/attribute_validation.rs`
102. `crates/graphcal-compiler/src/ir/resolve/include_selection.rs`
103. `crates/graphcal-compiler/src/hir/source_interface.rs`
104. `crates/graphcal-compiler/src/hir/types.rs`
105. `crates/graphcal-compiler/src/hir/diagnostics.rs`
106. `crates/graphcal-compiler/src/hir/lower.rs`
107. `crates/graphcal-compiler/src/hir/expr.rs`
108. `crates/graphcal-compiler/src/hir/node_definition.rs`
109. `crates/graphcal-compiler/src/ir/node_definition.rs`
110. `crates/graphcal-compiler/src/hir/nominal.rs`
111. `crates/graphcal-compiler/src/hir/mod.rs`
112. `crates/graphcal-compiler/src/hir/closed_expr.rs`
113. `crates/graphcal-compiler/src/ir/instance.rs`
114. `crates/graphcal-compiler/src/ir/extern_fns.rs`
115. `crates/graphcal-compiler/src/ir/registry_build.rs`
116. `crates/graphcal-compiler/src/ir/include.rs`
117. `crates/graphcal-compiler/src/ir/lower.rs`
118. `crates/graphcal-compiler/src/tir/presentation.rs`
119. `crates/graphcal-compiler/src/ir/resolve/formal_conformance.rs`
120. `crates/graphcal-compiler/src/ir/static_dependencies.rs`
121. `crates/graphcal-compiler/src/ir/static_external_surface_formal_conformance.rs`
122. `crates/graphcal-compiler/src/tir/template_closure.rs`
123. `crates/graphcal-compiler/src/tir/template_closure/formal_conformance.rs`
124. `crates/graphcal-compiler/src/tir/expression_facts/static_index.rs`
125. `crates/graphcal-compiler/src/tir/expression_facts.rs`
126. `crates/graphcal-compiler/src/tir/typed/type_expr.rs`
127. `crates/graphcal-compiler/src/tir/typed/specialization.rs`
128. `crates/graphcal-compiler/src/tir/typed/collect.rs`
129. `crates/graphcal-compiler/src/tir/dim_check/helpers.rs`
130. `crates/graphcal-compiler/src/tir/typed/model.rs`
131. `crates/graphcal-compiler/src/tir/typed/ops.rs`
132. `crates/graphcal-compiler/src/tir/typed.rs`
133. `crates/graphcal-compiler/src/tir/dim_check/mod.rs`
134. `crates/graphcal-compiler/src/tir/dim_check/builtins.rs`
135. `crates/graphcal-compiler/src/tir/typed/tests.rs`
136. `crates/graphcal-compiler/src/ir/resolve/tests.rs`
137. `crates/graphcal-compiler/src/tir/dim_check/tests.rs`
138. `crates/graphcal-compiler/src/tir/dim_check/infer/rules.rs`
139. `crates/graphcal-compiler/src/tir/dim_check/infer/mod.rs`
140. `crates/graphcal-compiler/src/tir/dim_check/infer/complex.rs`
141. `crates/graphcal-compiler/src/tir/dim_check/infer/builtin_call.rs`
142. `crates/graphcal-compiler/src/tir/dim_check/infer/linear_algebra.rs`
143. `crates/graphcal-compiler/src/tir/dim_check/plot.rs`
144. `crates/graphcal-compiler/src/tir/dim_check/presentation.rs`
145. `crates/graphcal-compiler/src/tir/dim_check/template_closure.rs`
146. `crates/graphcal-compiler/src/tir/expression_facts/tests.rs`
147. `crates/graphcal-compiler/src/tir/dim_check/expression_axes.rs`
148. `crates/graphcal-compiler/src/tir/dim_check/infer/hir.rs`
149. `crates/graphcal-compiler/src/tir/dim_check/expression_facts.rs`
150. `crates/graphcal-compiler/src/tir/dim_check/expression_facts/tests.rs`
151. `crates/graphcal-compiler/src/tir/dim_check/concrete_obligations.rs`
152. `crates/graphcal-compiler/src/tir/dim_check/model_schema.rs`
153. `crates/graphcal-io/src/atomic_write.rs`
154. `crates/graphcal-io/src/in_memory_fs.rs`
155. `crates/graphcal-io/src/real_fs.rs`
156. `crates/graphcal-io/src/source_tree.rs`
157. `crates/graphcal-io/src/ingestion.rs`
158. `crates/graphcal-io/src/overlay_fs.rs`
159. `crates/graphcal-io/src/lib.rs`
160. `crates/graphcal-package/src/lib.rs`
161. `crates/graphcal-plugin-abi/src/section.rs`
162. `crates/graphcal-plugin-abi/src/manifest.rs`
163. `crates/graphcal-plugin-abi/src/lib.rs`
164. `crates/graphcal-plugin-macros/src/lib.rs`
165. `crates/graphcal-plugin-macros/src/dims.rs`
166. `crates/graphcal-plugin-macros/src/parse.rs`
167. `crates/graphcal-plugin-macros/src/rational.rs`
168. `crates/graphcal-plugin-macros/src/lower.rs`
...
201. `crates/graphcal-eval/src/project_compiler/qualified_refs.rs`
202. `crates/graphcal-eval/src/project_compiler/generic_leakage.rs`
203. `crates/graphcal-eval/src/exec_plan.rs`
204. `crates/graphcal-eval/src/eval/plot_data.rs`
205. `crates/graphcal-eval/src/eval/project/model_schema.rs`
206. `crates/graphcal-eval/src/assertion_eval.rs`
207. `crates/graphcal-eval/src/execution_frame.rs`
208. `crates/graphcal-eval/src/eval/display.rs`
209. `crates/graphcal-eval/src/eval_expr/arithmetic.rs`
210. `crates/graphcal-eval/src/eval_expr/linear_algebra_lu.rs`
211. `crates/graphcal-eval/src/project_compiler/model.rs`
212. `crates/graphcal-eval/src/project_compiler/hir_project.rs`
213. `crates/graphcal-eval/src/project_compiler/registry_merge.rs`
214. `crates/graphcal-eval/src/eval/project/output.rs`
215. `crates/graphcal-eval/src/eval_expr/presentation.rs`
216. `crates/graphcal-eval/src/eval_expr/unit_scale.rs`
217. `crates/graphcal-eval/src/eval_expr/linear_algebra.rs`
218. `crates/graphcal-eval/src/host_fns.rs`
219. `crates/graphcal-eval/src/eval_expr/context.rs`
220. `crates/graphcal-eval/src/loader.rs`
221. `crates/graphcal-eval/src/project_compiler/pipeline.rs`
222. `crates/graphcal-eval/src/eval/public_projection.rs`
223. `crates/graphcal-eval/src/project_compiler/lowering.rs`
224. `crates/graphcal-eval/src/project_compiler/session.rs`
225. `crates/graphcal-eval/src/eval/runtime.rs`
226. `crates/graphcal-eval/src/eval/project/prepared.rs`
227. `crates/graphcal-eval/src/eval_expr/hir_eval.rs`
228. `crates/graphcal-eval/src/eval_expr/mod.rs`
229. `crates/graphcal-eval/src/eval/project/mod.rs`
230. `crates/graphcal-eval/src/project_compiler/mod.rs`
231. `crates/graphcal-eval/src/eval/mod.rs`
232. `crates/graphcal-eval/src/project_compiler/recursion.rs`
233. `crates/graphcal-eval/src/project_compiler/imports.rs`
234. `crates/graphcal-eval/src/project_compiler/execution_check/const_schedule.rs`
235. `crates/graphcal-eval/src/project_compiler/execution_check/domain_resolve.rs`
236. `crates/graphcal-eval/src/project_compiler/execution_check.rs`
237. `crates/graphcal-eval/src/project_compiler/checking.rs`
238. `crates/graphcal-eval/src/eval/project/binding_compile.rs`
239. `crates/graphcal-eval/src/eval/project/tenax_model.rs`
240. `crates/graphcal-eval/src/eval/tests.rs`
241. `crates/graphcal-eval/src/graph_ir/mod.rs`
242. `crates/graphcal-eval/src/graph_ir/dot.rs`
243. `crates/graphcal-eval/src/eval/tests/checked_expressions.rs`
244. `crates/graphcal-eval/src/eval/tests/presentation_evidence.rs`
245. `crates/graphcal-eval/src/eval/runtime/tests.rs`
246. `crates/graphcal-report/src/lib.rs`
247. `crates/graphcal-report/src/escape.rs`
248. `crates/graphcal-report/src/vega_assets.rs`
249. `crates/graphcal-report/src/report_hydrate.rs`
250. `crates/graphcal-report/src/vega.rs`
251. `crates/graphcal-report/src/plot_page.rs`
252. `crates/graphcal-report/src/value_display.rs`
253. `crates/graphcal-report/src/report_ir.rs`
254. `crates/graphcal-report/src/report_html.rs`
255. `crates/graphcal-report/src/report_markdown.rs`
256. `crates/graphcal-test-support/src/lib.rs`
257. `crates/graphcal-test-support/src/project.rs`
258. `crates/graphcal-test-support/src/bytes.rs`
259. `crates/graphcal-tenax/src/lib.rs`
260. `crates/graphcal-wasm/src/project.rs`
261. `crates/graphcal-wasm/src/output.rs`
262. `crates/graphcal-wasm/src/js_request.rs`
263. `crates/graphcal-wasm/src/diagnostics.rs`
264. `crates/graphcal-wasm/src/bindings.rs` →
     `crates/graphcal-wasm/src/browser_report.rs` →
     `crates/graphcal-wasm/src/prepared.rs`
265. `crates/graphcal-wasm/src/lib.rs`
266. `crates/graphcal-plugin-host/src/cache.rs`
267. `crates/graphcal-plugin-host/src/convert.rs`
268. `crates/graphcal-plugin-host/src/module.rs`
269. `crates/graphcal-plugin-host/src/registry.rs`
270. `crates/graphcal-plugin-host/src/host.rs`
271. `crates/graphcal-plugin-host/src/lib.rs`
272. `crates/graphcal-fmt/src/lib.rs`
273. `crates/graphcal-fmt/src/format/type_expr.rs`
274. `crates/graphcal-fmt/src/format/expr.rs`
275. `crates/graphcal-fmt/src/format/decl.rs`
276. `crates/graphcal-fmt/src/format/mod.rs`
277. `crates/graphcal-lsp/src/lib.rs`
278. `crates/graphcal-lsp/src/convert.rs`
279. `crates/graphcal-lsp/src/cursor_context.rs`
280. `crates/graphcal-lsp/src/symbol_identity.rs`
281. `crates/graphcal-lsp/src/nominal_type_index.rs`
282. `crates/graphcal-lsp/src/symbol_table.rs`
283. `crates/graphcal-lsp/src/project_symbols.rs`
284. `crates/graphcal-lsp/src/formatting.rs`
285. `crates/graphcal-lsp/src/workspace_revision.rs`
286. `crates/graphcal-lsp/src/analysis_schedule_state.rs`
287. `crates/graphcal-lsp/src/formatting_scheduler.rs`
288. `crates/graphcal-lsp/src/client_capabilities.rs`
289. `crates/graphcal-lsp/src/filesystem_events.rs`
290. `crates/graphcal-cli/src/lib.rs`
291. `crates/graphcal-lsp/src/diagnostics.rs`
292. `crates/graphcal-lsp/src/resolve.rs`
293. `crates/graphcal-lsp/src/completion.rs`
294. `crates/graphcal-lsp/src/signature_help.rs`
295. `crates/graphcal-lsp/src/inlay_hints.rs`
296. `crates/graphcal-lsp/src/document_symbols.rs`
297. `crates/graphcal-lsp/src/document_links.rs`
298. `crates/graphcal-lsp/src/code_actions.rs`
299. `crates/graphcal-lsp/src/goto_definition.rs`
300. `crates/graphcal-lsp/src/references.rs`
301. `crates/graphcal-lsp/src/hover.rs`
302. `crates/graphcal-lsp/src/rename.rs`
303. `crates/graphcal-lsp/src/server.rs`
304. `crates/graphcal-lsp/src/protocol_tests.rs`
305. `crates/graphcal-cli/src/display.rs`
306. `crates/graphcal-cli/src/format.rs`
307. `crates/graphcal-cli/src/json_input.rs`
308. `crates/graphcal-cli/src/overrides.rs`
309. `crates/graphcal-cli/src/main.rs`
310. `crates/graphcal-cli/src/report.rs`
311. `crates/graphcal-cli/src/model.rs`
312. `crates/graphcal-cli/src/dump.rs`
313. `crates/graphcal-cli/src/deps.rs`
314. Build-time shell (explicit path modules, curated beyond the heuristic):
...
315. `crates/graphcal-cli/src/plugin.rs`
316. `crates/graphcal-plugin/tests/expansion.rs`
317. `crates/graphcal-plugin/tests/prelude_drift.rs`
318. `crates/graphcal-plugin/tests/abi_memory.rs`
319. `crates/graphcal-eval/tests/todo.rs`
320. `crates/graphcal-eval/tests/declaration_order.rs`
321. `crates/graphcal-eval/tests/edge_case_bugs.rs`
322. `crates/graphcal-eval/tests/phase0_regressions.rs`
323. `crates/graphcal-eval/tests/error_snapshots.rs`
324. `crates/graphcal-eval/tests/generated_projects.rs`
325. `crates/graphcal-eval/tests/chunk5_regressions.rs`
326. `crates/graphcal-eval/tests/chunk6_regressions.rs`
327. `crates/graphcal-eval/tests/namespace_formal_conformance.rs`
328. `crates/graphcal-eval/tests/phase1_regressions.rs`
329. `crates/graphcal-report/tests/report.rs`
330. `crates/graphcal-wasm/tests/tutorial_examples.rs`
331. `crates/graphcal-wasm/tests/wasm_runtime.rs`
332. `crates/graphcal-wasm/tests/wasm_presentation.rs`
333. `crates/graphcal-plugin-host/tests/runtime.rs`
334. `crates/graphcal-plugin-host/tests/project_eval.rs`
335. `crates/graphcal-fmt/tests/todo.rs`
336. `crates/graphcal-fmt/tests/format_tests.rs`
337. `crates/graphcal-cli/tests/todo.rs`
338. `crates/graphcal-cli/tests/cli.rs`
339. `crates/graphcal-cli/tests/plugin_cmd.rs`
340. `crates/graphcal-cli/tests/plugin_e2e.rs`
341. `crates/graphcal-cli/tests/dump.rs`
342. `crates/graphcal-cli/tests/presentation.rs`
343. `crates/graphcal-cli/tests/report_engine.rs`
